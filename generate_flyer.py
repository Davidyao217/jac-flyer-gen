...
SVG_TEMPLATE = """<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 {width} {height}" width="100%" height="100%">
  ...
  <text class="cta-text" fill="#FFFDD0" x="120" y="780">
  ...
  <!-- Sponsors -->
  <text class="text location" x="960" y="1120" text-anchor="end" style="font-size: 28px;">SPONSORS:</text>
  {sponsors_logos}
...
def main():
    ...
    sponsors = [
        ...
        "clean_assets/lovable_logo_full.svg",
        "clean_assets/codex-text.svg",
        "clean_assets/jp_logo.svg",
        "clean_assets/ally.svg",
        "clean_assets/velric_logo.svg"
    ]
    scales = [1.0, 1.0, 1.0, 1.2, 0.8, 1.8]
    total_scale = 0.8
    scales = [scale * total_scale for scale in scales]

    y_positions = [1160, 1160, 1160, 1159, 1165, 1145]
    x_positions = [50, 180, 350, 515, 715, 790]
    ...
    guide_y = 1190  # Adjust this value to move the horizontal line
    ...
    output_path = os.path.join(os.path.dirname(__file__), "flyer.svg")
