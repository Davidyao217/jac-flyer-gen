...
SVG_TEMPLATE = """<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 {width} {height}" width="100%" height="100%">
  <defs>
    <style>
      ...
      .building {{ stroke: #1C1008; stroke-width: 3; fill: none; opacity: 0.7; stroke-linecap: round; stroke-linejoin: round; }}
    </style>
  ...
  <g transform="translate(55, 0) scale(0.65)" class="building">
    {building_paths}
  </g>
  ...
  <!-- Year "2026" -->
  <text x="150" y="800" style="font-family: 'Arial Black', 'Impact', 'Helvetica', sans-serif; font-size: 90px; font-weight: 900; fill: #1C1008;">2026</text>
